...
import terms from 'assets/images/icons/terms.png';
import anywhere from 'assets/images/icons/anywhere.png';
  ...
  feature: [
    {
      ...
      description: 'From a single desk, all the way up to configured offices.',
    },
    {
      id: 2,
      icon: terms,
      title: 'On your terms',
      description: 'By the hour, the day, the month, or longer term.',
    },
    {
      id: 3,
      icon: anywhere,
      title: 'From anywhere',
      description: 'Choose a location, or access any building worldwide. ',
    },
  ],
  gallery: [
    {
      ...
      <Container>
        <Box sx={styles.contentWrapper}>
          <Box sx={styles.leftContent}>
            <SectionHeading
              sx={styles.heading}
              title="Some good place to where can build and scale your business"
              description="For companies of all sizes, Saasm provides the global scale and flexibility to help your business adapt to uncertainty. Find the space that's right for you."
            />
