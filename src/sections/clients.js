...
const Clients = () => {
  ...
  return (
    <Box id="clients" as="section" sx={styles.section}>
      <Container>
        <SectionHeading
          slogan="Trusted by the world’s top companies "
          title="From entrepreneurs to Fortune 500s, we’re listening and learning from our global community of businesses as they adapt and reinvent."
        />
