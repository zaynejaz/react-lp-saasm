      ...
      <Container>
        <Flex sx={styles.contentWrapper}>
          ...
          <Box sx={styles.rightContent}>
            <SectionHeading
              sx={styles.heading}
              title="Workspace where and how you need it"
              description="With over 800 locations worldwide, Saasm offers you workspace where and how you need it, whether your goal is to be closer to home, empower your team in different cities, or have a go-to private space where you can actually focus. "
            />
