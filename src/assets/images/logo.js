...
const Logo = ({ isWhite, ...props }) => {
  return (
    <svg viewBox="0 0 332 130" width={164} height={36.62} {...props}>
      ...
      <g data-name="Layer 2">
        <g data-name="Layer 1">
          ...
          <path fill={isWhite ? 'white' : '#0f2137'} d="M137,49.2c2.4,1.5,4.3,3.5,5.7,6l-4.8,4c-2.3-3.7-5.3-5.6-9-5.6c-1.8,0-3.4,0.5-4.6,1.4c-1.3,1-1.9,2.3-1.9,4.2c0,1.6,0.5,2.8,1.4,3.6c0.9,0.8,2.5,1.8,4.6,2.9l4.8,2.4c3.5,1.7,6.1,3.6,7.7,5.6s2.5,4.5,2.5,7.6c0,4-1.4,7.2-4.1,9.7s-6.2,3.7-10.3,3.7c-3.5,0-6.7-0.9-9.5-2.7c-2.8-1.8-5.1-4.2-6.7-7.4l4.9-4c3.2,4.9,6.9,7.4,11.3,7.4c2.2,0,4-0.6,5.4-1.8s2.1-2.7,2.1-4.7c0-1.6-0.5-2.9-1.5-3.9s-2.6-2-4.8-3.1l-4.8-2.4c-3.2-1.5-5.6-3.3-7.4-5.3c-1.8-2-2.6-4.5-2.6-7.5c0-3.7,1.3-6.8,3.9-9.1c2.6-2.3,5.8-3.5,9.6-3.5C131.8,46.9,134.5,47.7,137,49.2z"/>
          <path fill={isWhite ? 'white' : '#0f2137'} d="M177.6,86.2h-19.3l-3.1,7.7h-7.4l18.9-47h2.3l18.9,47h-7.4L177.6,86.2z M168,60.6l-7.2,19.2h14.3L168,60.6z"/>
          <path fill={isWhite ? 'white' : '#0f2137'} d="M220.7,86.2h-19.3l-3.1,7.7H191l18.9-47h2.3l18.9,47h-7.4L220.7,86.2z M211.1,60.6l-7.2,19.2h14.3L211.1,60.6z"/>
          <path fill={isWhite ? 'white' : '#0f2137'} d="M258.9,49.2c2.4,1.5,4.3,3.5,5.7,6l-4.8,4c-2.3-3.7-5.3-5.6-9-5.6c-1.8,0-3.4,0.5-4.6,1.4c-1.3,1-1.9,2.3-1.9,4.2c0,1.6,0.5,2.8,1.4,3.6c0.9,0.8,2.5,1.8,4.6,2.9l4.8,2.4c3.5,1.7,6.1,3.6,7.7,5.6s2.5,4.5,2.5,7.6c0,4-1.4,7.2-4.1,9.7c-2.7,2.5-6.2,3.7-10.3,3.7c-3.5,0-6.7-0.9-9.5-2.7c-2.8-1.8-5.1-4.2-6.7-7.4l4.9-4c3.2,4.9,6.9,7.4,11.3,7.4c2.2,0,4-0.6,5.4-1.8s2-2.7,2-4.7c0-1.6-0.5-2.9-1.5-3.9s-2.6-2-4.8-3.1l-4.8-2.4c-3.2-1.5-5.6-3.3-7.4-5.3c-1.8-2-2.6-4.5-2.6-7.5c0-3.7,1.3-6.8,3.9-9.1c2.6-2.3,5.8-3.5,9.6-3.5C253.7,46.9,256.5,47.7,258.9,49.2z"/>
          <path fill={isWhite ? 'white' : '#0f2137'} d="M314.9,46.9v47H308v-29l-12.3,17.4h-2.3L281,64.9v29h-6.9v-47h2.4l18,25.8l18-25.8H314.9z"/>
